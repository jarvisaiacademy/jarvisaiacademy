                    ...
                    >
                      ...
                      <td className="py-3.5 px-4 sm:px-6">
                        <button
                          ...
                          title={`Click to ${isInactive ? "activate" : "deactivate"} admin`}
                        >
                          <span
                        ...
                        <div className="flex items-center justify-end gap-1.5">
                          ...
                          {deleteConfirmId === admin.id ? (
                            ...
                            <button
                              ...
                              className="p-1.5 rounded-lg text-white bg-red-600 hover:bg-red-500 shadow-xs transition-colors cursor-pointer disabled:opacity-30 disabled:cursor-not-allowed inline-flex items-center justify-center"
