    ...
    <div className="flex flex-col px-2 py-2">
      ...
      <div className="flex flex-col gap-0.5">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 text-xs text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white transition-colors text-left cursor-pointer"
        >
          {showMore ? (
            <>
