...
export const COURSES_DATA: CourseItem[] = [
  ...
  },
  {
    ...
    description: "High-intensity cohort capped strictly at 10 candidates. Includes 1-on-1 mentorship, daily commercial code reviews, distributed system design, and guaranteed job placement.",
    category: "elite",
  ...
  },
  {
    ...
    description: "Know someone aiming to break into software engineering? Refer them to any 60-day cohort at Jarvis AI Academy and earn ₹5,000 cash reward once they complete the course.",
    category: "elite",
    categoryLabel: "Super10 Elite",
    badge: "🎁 ₹5,000 Reward",
    badgeType: "popular",
    ...
    techIcons: [],
    topics: [
      "₹5,000 Cash Reward per Referral",
