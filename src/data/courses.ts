...
export const COURSES_DATA: CourseItem[] = [
  ...
  },
  {
    ...
    description: "Know someone aiming to break into software engineering? Refer them to any 60-day cohort at Jarvis AI Academy and earn ₹3,000 cash reward once they complete the course.",
    category: "elite",
    categoryLabel: "Super10 Elite",
    badge: "🎁 ₹3,000 Reward",
    badgeType: "popular",
